    ...
    var Treeview =
      ...
      (function () {
        ...
        _proto.toggle = function toggle(event) {
          ...
          var hasChildren = $parent[0].children[1].children.length > 1;
         if (hasChildren) {
            event.preventDefault();
            if (isOpen) {
              event.preventDefault();
              ...
              // window.location.href = $parent[0].children[1].children[0].children[0].href;
              event.preventDefault();
            }

          } else {
            window.location.href = $parent[0].children[1].previousElementSibling.href;
            event.preventDefault();
            return;
          }
